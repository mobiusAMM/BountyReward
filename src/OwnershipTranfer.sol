...
contract MobiusOwnershipTransfer {
    ...
    address constant MOBI_ADDRESS = 0x73a210637f6F6B7005512677Ba6B3C96bb4AA44B;
    uint constant EXPECTED_MOBI_BALANCE = 300_000_000 * 10 ** 18;
    ...
    function checkTimelockBalance() internal {
        require(IERC20(MOBI_ADDRESS).balanceOf(TIMELOCK) >= EXPECTED_MOBI_BALANCE, "Not enough mobi in timelock");
    }
